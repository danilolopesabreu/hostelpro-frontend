...
import { DailyCheckinSummaryComponent } from '@shared/components/daily-checkin-summary/daily-checkin-summary.component';
import { MiniRevenueComparisonComponent } from '@shared/components/mini-revenue-comparison/mini-revenue-comparison.component';
import { AverageStayDurationComponent } from '@shared/components/average-stay-duration/average-stay-duration.component';
import { MiniWeatherWidgetComponent } from '@shared/components/mini-weather-widget/mini-weather-widget.component';
import { OccupancyForecastMiniComponent } from '@shared/components/occupancy-forecast-mini/occupancy-forecast-mini.component';
import { GuestSatisfactionChartComponent } from '@shared/components/guest-satisfaction-chart/guest-satisfaction-chart.component';
import { RoomStatusOverviewComponent } from '@shared/components/room-status-overview/room-status-overview.component';
import { HotelServicesRevenueComponent } from '@shared/components/hotel-services-revenue/hotel-services-revenue.component';
...
@Component({
  ...
  imports: [
    ...
    DailyCheckinSummaryComponent,
    MiniRevenueComparisonComponent,
    AverageStayDurationComponent,
    MiniWeatherWidgetComponent,
    OccupancyForecastMiniComponent,
    GuestSatisfactionChartComponent,
    RoomStatusOverviewComponent,
    HotelServicesRevenueComponent,
  ],
