import { QuickAccessCardComponent } from '@shared/components/quick-access-card/quick-access-card.component';
...
import { OccupancyRateWidgetComponent } from '@shared/components/occupancy-rate-widget/occupancy-rate-widget.component';
import { BookingTrendsChartComponent } from '@shared/components/booking-trends-chart/booking-trends-chart.component';
import { RevenueSummaryCardComponent } from '@shared/components/revenue-summary-card/revenue-summary-card.component';
import { GeographicSourceComponent } from '@shared/components/geographic-source/geographic-source.component';
import { ServiceRequestSummaryComponent } from '@shared/components/service-request-summary/service-request-summary.component';
import { GuestDemographicsSnapshotComponent } from '@shared/components/guest-demographics-snapshot/guest-demographics-snapshot.component';
...
@Component({
  ...
  imports: [
    ...
    GuestDemographicsSnapshotComponent,
  ],
})
